...
import wandb
import numpy as np
from transformers import Seq2SeqTrainingArguments, training_args
from sklearn.model_selection import StratifiedKFold, train_test_split


from training import Training
from dataloaders import CheXAgentDataset
...
class CrossValidation:
    def __init__(self, k_folds, random_seed):
        ...
        self.training_pipeline = Training()
    ...
    def __call__(self, preprocessing_model: T5WithInversionHead, slake_dataset, variation_dataset, early_stopping, training_args: Seq2SeqTrainingArguments, wandb_login_key):
        ...
        for fold, (train_ids, validation_ids) in enumerate(dataset_splits):
            ...
            training_args.output_dir = new_weights_name
            ...
            preprocessing_model = type(preprocessing_model).from_pretrained(base_model)
            ...
            self.training_pipeline(preprocessing_model, train_dataset, validation_dataset, test_dataset, early_stopping=early_stopping,training_args=training_args, wandb_login_key=wandb_login_key)

            with open(f'{new_weights_name}/fold_splits.json', 'w') as f:
                json.dump({ 'train_ids': train_ids, 'validation_ids': validation_ids, 'test_ids': test_ids }, f, ensure_ascii=False, indent=4)
...
if __name__ == "__main__":
    ...
    cross_validation = CrossValidation(3, 42)
